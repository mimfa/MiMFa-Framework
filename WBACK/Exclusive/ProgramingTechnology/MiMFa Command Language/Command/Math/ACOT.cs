...
{
    public class ACOT : CommandBase
    {
        public override string description => "Arc Cotangent calculations";
        public override string aliasname => "arccot";
        public ACOT() : base()
        {
        }
        ...
        {
            return 1 / Math.Atan(MiMFa_Convert.ForceToDouble(obj));
        }
        #endregion
    }
}
