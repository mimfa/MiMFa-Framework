...
{
    public class ASIN : CommandBase
    {
        public override string description => "Arc Sinus calculations";
        public override string aliasname => "arcsin";
        public ASIN() : base()
        {
        }
        ...
        {
            return Math.Asin(MiMFa_Convert.ForceToDouble(obj));
        }
        #endregion
    }
}
