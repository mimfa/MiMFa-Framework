...
{
    public class INF : CommandBase
    {
        public override string description => "Infinity number";
        public override string aliasname => "nan";
        public INF() : base()
        {
        }
        ...
        public static double inf = 9999999999999999999;
        #endregion
    }
}
