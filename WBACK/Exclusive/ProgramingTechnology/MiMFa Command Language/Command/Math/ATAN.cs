...
{
    public class ATAN : CommandBase
    {
        public override string description => "Arc Tangent calculations";
        public override string aliasname => "arctan";
        public ATAN() : base()
        {
        }
        ...
        {
            return Math.Atan(MiMFa_Convert.ForceToDouble(obj));
        }
        #endregion
    }
}
