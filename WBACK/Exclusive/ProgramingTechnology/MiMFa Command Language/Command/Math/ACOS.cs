...
{
    public class ACOS : CommandBase
    {
        public override string description => "Arc Cosine calculations";
        public override string aliasname => "arccos";
        public ACOS() : base()
        {
        }
        ...
        {
            return Math.Acos(MiMFa_Convert.ForceToDouble(obj));
        }
        #endregion
    }
}
