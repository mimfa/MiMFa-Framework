...
{
    public class PROTECTED : CommandBase
    {
        public override string description => "Operations access for childs";
    ...
    + " "
     ...
     + MCLTools.SignFinish;
        ...
        {
            MCL.PushAccess(Collection.MiMFa_ProgrammingAccessibility.Protected);
