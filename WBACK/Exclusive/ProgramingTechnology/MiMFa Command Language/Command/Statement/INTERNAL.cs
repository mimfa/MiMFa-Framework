...
{
    public class INTERNAL : CommandBase
    {
        public override string description => "Operations access in this space";
    ...
    + " "
     ...
     + MCLTools.SignFinish;
        ...
        {
            MCL.PushAccess(Collection.MiMFa_ProgrammingAccessibility.Internal);
