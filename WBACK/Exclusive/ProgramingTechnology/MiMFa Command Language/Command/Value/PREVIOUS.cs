...
{
    public class PREVIOUS : CommandBase
    {
        public override string description => "Return last command";
        public override string aliasname => "prev";
        public PREVIOUS() : base()
        {
        }
