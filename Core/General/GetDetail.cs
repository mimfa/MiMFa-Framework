...
namespace MiMFa_Framework.General
{
    public class MiMFa_GetDetail
    {
        ...
        public static bool IsText(object value)
        {
            if (value is string
                || value is String
                || value is System.IO.Stream) return true;
            return false;
        }
        ...
        public static bool IsHTMLContent(object value)
        {
            ...
            if (MiMFa_StringService.GetFirstWordBetween(value + "","<",">") != null) return true;
            return false;
        }
        ...
        {
            Type t = obj.GetType();
            MethodInfo[] methods = MiMFa_CollectionService.Concat(t.GetMethods(), t.GetRuntimeMethods().ToArray());
        ...
        {
            return MiMFa_Net.GetInternalIPv4(hostName);
        }
