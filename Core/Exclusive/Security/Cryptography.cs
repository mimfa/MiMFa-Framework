...
namespace MiMFa_Framework.Exclusive.Security
{
    public class MiMFa_Cryptography
    {
        ...
        {
            return General.MiMFa_Math.ModOfPowerElement(plain, e, n);
        }
        public int RSACiphertoPlain(int cipher, int d, int n)
        {
            return General.MiMFa_Math.ModOfPowerElement(cipher, d, n);
        }
