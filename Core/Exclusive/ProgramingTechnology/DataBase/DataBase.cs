...
{
    public interface MiMFa_DataBase_ITypes
    {
        string INT { get; set; }
    ...
    public interface MiMFa_IDataBase : IProgramingTechnology
    {
        MiMFa_DataBase_ITypes TYPE { get; set; }
        ...
        object Execute(string query, MiMFa_ExecuteType executeType, params DbParameter[] parameters);
        object Execute(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, string[] names, params object[] parameters);
        object Execute(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, params DbParameter[] parameters);
        object Execute(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, string appendQuery, params DbParameter[] parameters);
        object Execute(string query, MiMFa_ExecuteType executeType, DbParameterCollection parameters);
        object Execute(string query, MiMFa_ExecuteType executeType);
        object Execute<T>(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, string appendQuery, T thisClass);
        object Execute<T>(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, T thisClass);
        object Execute<T>(string query, MiMFa_ExecuteType executeType, T thisClass);
        List<object> Execute<T>(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, string appendQuery, params T[] classes);
        List<object> Execute<T>(string query, MiMFa_ExecuteType executeType, bool createParameterName, bool createColumnName, params T[] classes);
        List<object> Execute<T>(string query, MiMFa_ExecuteType executeType, params T[] classes);
