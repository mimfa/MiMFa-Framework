...
namespace MiMFa_Framework.Exclusive.Accessibility
{
    public class MiMFa_PropertyToContentInjection
    {
        public char SignChar = '§';
        public object[] Objects = { };

        public MiMFa_PropertyToContentInjection(char signChar, params object[] objects)
        {
            try
            {
        ...
        public MiMFa_PropertyToContentInjection()
        { }
