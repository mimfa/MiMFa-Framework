...
namespace MiMFa_Framework.Network.TCP
{
    public class MiMFa_DataTransit
    {
        ...
        public IPAddress InterlocutorIP { get; set; } = MiMFa_Net.GetInternalIPv4();
        ...
        public void SocketReceive()
        {
            ...
            if (InterlocutorIP != null)
            {
                ...
                while (Run)
                {
                    ...
                    bool b = mi > 0;
                    if (b && EndDownloadData != null) EndDownloadData(MiMFa_IOService.Deserialize(bytarr), InterlocutorIPEndPoint, mi);
                    socket.Close();
                }
                listener.Stop();
                StopDownloadData(null, InterlocutorIPEndPoint, 0);
