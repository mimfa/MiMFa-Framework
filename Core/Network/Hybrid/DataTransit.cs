...
namespace MiMFa_Framework.Network.Hybrid
{
    public class MiMFa_DataTransit
    {
        #region Property
        ...
        public FTP.MiMFa_DataTransit FTP { get; set; } = null;
        public TCP.MiMFa_Sender Sender { get; set; } = new TCP.MiMFa_Sender();
        public TCP.MiMFa_Receiver Receiver { get; set; } = new TCP.MiMFa_Receiver();
        ...
        public IPAddress FTPInterlocutorIP { get; set; } = MiMFa_Net.GetInternalIPv4();
        ...
        #region Constructor
        public MiMFa_DataTransit(string hostIP, string userName, string password)
        {
            SenderInterlocutorIP = FTPInterlocutorIP = IPAddress.Parse(hostIP); UserName = userName; Password = password;
            FTP = new Network.FTP.MiMFa_DataTransit(@"ftp://" + hostIP + "/", userName, password);
            AddEvent();
        }
        public MiMFa_DataTransit(IPAddress hostIP, string userName, string password)
        {
