...
{
  public  class MiMFa_Regularization
    {
        ...
        public static void ChildControlsLayout<T>(T control, MiMFa_Layout layout) where T : Control
        {
            switch(layout)
            {
                case MiMFa_Layout.Horizental:
                    ChildControlsHorizentalLayout(control);
                    break;
                case MiMFa_Layout.Vertical:
                    ChildControlsVerticalLayout(control);
                    break;
                case MiMFa_Layout.Both:
