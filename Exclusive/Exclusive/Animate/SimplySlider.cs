...
{
    public class MiMFa_SimplySlider
    {
        public MiMFa_SimplySlider(int speed = 10)
        {
            try
            {
                Active = false;
        ...
        public void AddControl<T, F>(T container, F actor, DockStyle sideEffect) where T : Control where F : Control
        {
            actor.Click += (o, e) =>
           {
               if (container.Visible)
                   EndEffect(container, sideEffect);
               else
                   StartEffect(container, sideEffect);
           };
        }
        public void StartEffect<T>(T container, DockStyle sideEffect) where T : Control
        {
            try
            {
        ...
        public void EndEffect<T>(T container, DockStyle sideEffect) where T : Control
        {
            try
            {
