...
namespace MiMFa_Framework.Exclusive.Effect
{
    public class MiMFa_Highlight
    {
        ...
        public Image HilightBackImage = MiMFa_Framework.Properties.Resources.BackV3;
        public BorderStyle HilightBorderStyle = BorderStyle.FixedSingle;

        public MiMFa_Highlight(Color hilightBackColor, Color hilightForeColor, Image hilightBackImage = null, bool prevBackImageView = false)
        {
        ...
        public MiMFa_Highlight(Image hilightBackImage = null, bool prevBackImageView = false)
        {
            PrevBackImageView = prevBackImageView;
            HilightBackImage = hilightBackImage;
            if (HilightBackImage == null) HilightMode = Mode.BackColor;
        ...
        public MiMFa_Highlight(Mode hilightMode, bool prevBackImageView = false)
        {
            PrevBackImageView = prevBackImageView;
            HilightMode = hilightMode;
            if (HilightMode != Mode.BackColor) HilightBackImage = Properties.Resources.BackV3;
        }
